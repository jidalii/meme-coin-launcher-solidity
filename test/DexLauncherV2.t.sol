...
import "../src/core/interfaces/IDexLauncherV2.sol";
import "../src/token/ERC20.sol";

import {Swap} from "./MockUniswapV3Swap.sol";

contract DexLauncherV2Test is Test {
    string internal BSC_MAINNET_PRC = "https://bsc-rpc.publicnode.com";
    string internal NEOX_TESTNET_PRC = "https://neoxt4seed1.ngd.network/";
    ...
    address private wgas = address(0x1CE16390FD09040486221e912B87551E4e44Ab17);
    ...
    DexLauncherV2 private dexLauncher;
    ...
    function setUp() public {
        uint256 forkId = vm.createFork(NEOX_TESTNET_PRC);
        vm.selectFork(forkId);

        console.log("in NeoX testnet");
    ...
    function test_TokenLaunch() public {
        ...
        uint256 wgasAmount = 1_000 ether;
        ...
        vm.roll(3);
        (address pool, uint256 liquidity, uint256 amount0, uint256 amount1) =
